<template>
  <div>
    <section class="container">
      <div class="p-6 flex flex-col gap-2 max-w-lg mx-auto pt-32">
      ...
      <div v-if="searchQuery" class="p-6">
        <div
          ...
          class="cards my-2 grid gap-4 md:grid-cols-2/70"
        >
      ...
      <div v-else class="p-6">
        <h1 class="text-xl text-center sm:text-start">
          Daftar cerita yang tersedia
        </h1>
